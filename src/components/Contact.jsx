              ...
              <div className="relative z-10">
                ...
                <div className="mb-8">
                  <button
                    ...
                    className="w-full group relative bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold py-4 px-6 rounded-2xl shadow-lg shadow-green-500/25 hover:shadow-xl hover:shadow-green-500/30 transition-all duration-300 transform hover:-translate-y-1 flex items-center justify-center gap-3 overflow-hidden"
                  >
                    ...
                    <ExternalLink size={16} className="relative z-10 opacity-70" />
                  </button>
                </div>
